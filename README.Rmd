...
- Allow developers to create their own preprocessors by exporting much of the underlying infrastructure of `mold()` and `forge()`.

- Provide extra utility functions for additional common tasks such as validating user input, adding intercept columns, and standardizing `predict()` output.
