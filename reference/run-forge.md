...
[`forge()`](https://hardhat.tidymodels.org/reference/forge.md) and
...
[`forge()`](https://hardhat.tidymodels.org/reference/forge.md) with the
same arguments, unlike
...
returned from
[`forge()`](https://hardhat.tidymodels.org/reference/forge.md). See the
return value section of
[`forge()`](https://hardhat.tidymodels.org/reference/forge.md) to
