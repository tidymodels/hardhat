...
- ptypes:
  ...
  automatically at
  [`mold()`](https://hardhat.tidymodels.org/reference/mold.md) time and
  is used to validate `new_data` at prediction time.
...
- formula:
  ...
  [`mold()`](https://hardhat.tidymodels.org/reference/mold.md) time.
...
- levels:
  ...
  factors during
  [`mold()`](https://hardhat.tidymodels.org/reference/mold.md). This
