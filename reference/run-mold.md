...
interface to
[`mold()`](https://hardhat.tidymodels.org/reference/mold.md) that is
used:
...
and write a new
[`mold()`](https://hardhat.tidymodels.org/reference/mold.md) method
...
from [`mold()`](https://hardhat.tidymodels.org/reference/mold.md). See
the return value section of
[`mold()`](https://hardhat.tidymodels.org/reference/mold.md) to
