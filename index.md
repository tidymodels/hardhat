...
- [`vignette("forge", "hardhat")`](https://hardhat.tidymodels.org/articles/forge.md):
...
- [`vignette("package", "hardhat")`](https://hardhat.tidymodels.org/articles/package.md):
  Learn how to use
  [`mold()`](https://hardhat.tidymodels.org/reference/mold.md) and
  [`forge()`](https://hardhat.tidymodels.org/reference/forge.md) to help
  in creating a new modeling package.
