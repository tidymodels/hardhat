...
The counterpart to
[`mold()`](https://hardhat.tidymodels.org/reference/mold.md) (which you
can read all about in
[`vignette("mold", "hardhat")`](https://hardhat.tidymodels.org/articles/mold.md)),
is [`forge()`](https://hardhat.tidymodels.org/reference/forge.md). Where
[`mold()`](https://hardhat.tidymodels.org/reference/mold.md) is used to
preprocess your training data,
[`forge()`](https://hardhat.tidymodels.org/reference/forge.md) is used
to preprocess new data that you are going to use to generate predictions
from your model.

Like [`mold()`](https://hardhat.tidymodels.org/reference/mold.md),
[`forge()`](https://hardhat.tidymodels.org/reference/forge.md) is not
intended to be used interactively. Instead, it should be called from the
[`predict()`](https://rdrr.io/r/stats/predict.html) method for your
...
[`forge()`](https://hardhat.tidymodels.org/reference/forge.md) offers.

## Connection with mold()

When [`mold()`](https://hardhat.tidymodels.org/reference/mold.md) is
used, one of the returned objects is an `blueprint`. This is the key to
preprocessing new data with
[`forge()`](https://hardhat.tidymodels.org/reference/forge.md). For
instance, assume you’ve called
[`mold()`](https://hardhat.tidymodels.org/reference/mold.md) like so:
...
[`forge()`](https://hardhat.tidymodels.org/reference/forge.md) along
...
[`mold()`](https://hardhat.tidymodels.org/reference/mold.md) was called.

[`forge()`](https://hardhat.tidymodels.org/reference/forge.md) always
returns three things, and they should look familiar to you if you have
used [`mold()`](https://hardhat.tidymodels.org/reference/mold.md).
...
- `extras` varies per blueprint, but is a catch-all slot to hold the
  ...
  [`mold()`](https://hardhat.tidymodels.org/reference/mold.md) was
  called.
...
[`forge()`](https://hardhat.tidymodels.org/reference/forge.md) is its
...
same *type* as the data used at fit time. *Type* is defined in the
...
data. [`forge()`](https://hardhat.tidymodels.org/reference/forge.md)
...
When we [`forge()`](https://hardhat.tidymodels.org/reference/forge.md),
we can request `outcomes` to have the predictors and outcomes separated
...
be required to
[`forge()`](https://hardhat.tidymodels.org/reference/forge.md), even if
you aren’t requesting them.
...
[`forge()`](https://hardhat.tidymodels.org/reference/forge.md) is
